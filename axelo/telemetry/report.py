    ...
    *,
    ...
    payload = {
        ...
        "target": {
            ...
            "selected_contract": target.selected_contract.model_dump(mode="json") if target.selected_contract else None,
            "request_contracts": [item.model_dump(mode="json") for item in target.request_contracts],
            "dataset_contract": target.dataset_contract.model_dump(mode="json"),
            "capability_profile": target.capability_profile.model_dump(mode="json"),
        },
        ...
        "result": {
            ...
            "adapter_package_path": str(generated.adapter_package_path) if generated and generated.adapter_package_path else None,
